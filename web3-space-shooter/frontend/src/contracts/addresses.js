...
export const NFTSpaceshipABI = [
  ...
  "function getPriceByRarity(uint8 rarity) pure returns (uint256)",
  "function balanceOf(address owner) view returns (uint256)",
  "function ownerOf(uint256 tokenId) view returns (address)",
  "function totalSupply() view returns (uint256)",
  "function tokenOfOwnerByIndex(address owner, uint256 index) view returns (uint256)",
  "function COMMON_PRICE() view returns (uint256)",
  "function RARE_PRICE() view returns (uint256)",
  "function EPIC_PRICE() view returns (uint256)",
  "function LEGENDARY_PRICE() view returns (uint256)",
